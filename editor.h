...
static void Editor_undo(Editor* editor, size_t max_visual_width, size_t max_visual_height) {
    ...
    case ACTION_INSERT_CH: {
        Text_box_del(&editor->file_text, action_to_undo.cursor, max_visual_width, max_visual_height);
    ...
    case ACTION_BACKSPACE_CH: {
        Text_box_insert(&editor->file_text, action_to_undo.ch, action_to_undo.cursor, max_visual_width, max_visual_height);
...
static void Editor_redo(Editor* editor, size_t max_visual_width, size_t max_visual_height) {
    ...
    case ACTION_INSERT_CH: {
        Text_box_del(&editor->file_text, action_to_redo.cursor, max_visual_width, max_visual_height);
    ...
    case ACTION_BACKSPACE_CH: {
        Text_box_insert(&editor->file_text, action_to_redo.ch, action_to_redo.cursor, max_visual_width, max_visual_height);
